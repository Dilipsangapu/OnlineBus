...
// ===== OTP FUNCTIONALITY (YOUR VERSION) =====
function sendOtp() {
...
function verifyOtp() {
    ...
    .then(res => res.text().then(text => {
        ...
        // ✅ Show and enable Submit & Register button
        const finalBtn = document.getElementById("finalRegisterBtn");
        finalBtn.style.display = "block";
        finalBtn.disabled = false;
        finalBtn.textContent = "Submit & Register";

        // ✅ Optional: Disable the OTP input to prevent editing
    ...
    .finally(() => {
        // Reset verifyBtn only if verification failed
